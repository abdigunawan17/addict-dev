    ...
    return (
        <header className="w-full bg-slate-800 p-2 rounded-lg flex flex-row justify-between">
                ...
                {dataFollow.data.length > 0 && 
                    <button className="bg-slate-900 p-2 rounded-lg" onClick={handleUnfollow}>Unfollow</button> 
                }
                {dataFollow.data.length == 0 && 
                    <button className="bg-slate-900 p-2 rounded-lg" onClick={handleFollow}>Follow</button> 
                }
